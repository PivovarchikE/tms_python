...
class Survey(Base):
    ...
    options: Mapped[list['Option']] = relationship(
        'Option', back_populates='survey', cascade="all, delete"
    )
    votes: Mapped[list['Vote']] = relationship(
        'Vote', back_populates='survey', cascade="all, delete"
    )
...
class Option(Base):
    ...
    survey: Mapped['Survey'] = relationship(
        'Survey', back_populates='options'
    )
    vote_options: Mapped[list['VoteOption']] = relationship(
        'VoteOption',
